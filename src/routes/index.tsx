            ...
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-[2fr_3fr]">
              ...
              <div>
                ...
                <p className="mt-5 text-pretty text-white/75 md:text-lg">
                  confeiteira, empreendedora e mentora. a Ruth viveu na pele os
                  desafios de transformar talento em negócio rentável. hoje ela
                  ajuda mulheres como você a passar por esse caminho com
                  segurança e apoio.
                </p>
